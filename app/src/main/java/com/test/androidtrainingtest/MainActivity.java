...
import com.test.androidtrainingtest.fragment.HomeFragment;
import com.test.androidtrainingtest.fragment.ResultFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static String CURRENT_TAG = TAG_QUESTION;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtWebsite = (TextView) findViewById(R.id.nav_city);
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("Qushay Bagas");
        txtWebsite.setText("bagas.qushay@gmail.com");
    }
    ...
    private Fragment getHomeFragment() {
        switch (navItemIndex) {
            ...
            case 1:
                // photos
                ResultFragment sresultFragment = new ResultFragment();
